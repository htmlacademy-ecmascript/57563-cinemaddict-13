...
/* harmony import */ var _model_comments_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../model/comments.js */ "./src/model/comments.js");
...
class Api {
  ...
  getMovies() {
    return this._load({url: `movies`})
      .then(Api.toJSON)
      .then((movies) => movies.map(_model_films_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient));
  }

  getComments(movieId) {
    return this._load({url: `comments/${movieId}`})
      .then(Api.toJSON)
      .then((comments) => comments.map(_model_comments_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToClient));
  }

  updateMovies(movie) {
    return this._load({
      url: `movies/${movie.id}`,
      method: _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["Method"].PUT,
      body: JSON.stringify(_model_films_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer(movie)),
      headers: new Headers({"Content-Type": `application/json`})
    }).then(Api.toJSON).then(_model_films_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient);
  }

  deleteComment(comment) {
    return this._load({
      url: `comments/${comment.id}`,
      method: _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["Method"].DELETE
    });
  }
  ...
  addComment(comment, movieId) {
    return this._load({
      ...
      method: _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["Method"].POST,
      body: JSON.stringify(_model_comments_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToServer(comment)),
      headers: new Headers({
        "Content-Type": `application/json`
      })
    })
      .then(Api.toJSON)
      .then(_model_comments_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToClient);
  }
  ...
  _load({
    url,
    method = _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["Method"].GET,
    body = null,
    headers = new Headers()
  }) {
  ...
  static checkStatus(response) {
    if (
      response.status < _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["SuccessHTTPStatusRange"].MIN &&
      response.status > _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["SuccessHTTPStatusRange"].MAX
    ) {
  ...
  getMovies() {
    if (Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["isOnline"])()) {
      return this._api.getMovies()
        .then((movies) => {
          const items = createStoreStructure(movies.map(_model_films_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer));
    ...
    return Promise.resolve(storeMovies.map(_model_films_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient));
  }
  ...
  updateMovies(movie) {
    if (Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["isOnline"])()) {
      return this._api.updateMovies(movie)
        .then((updatedMovie) => {
          this._store.setItem(updatedMovie.id, _model_films_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer(updatedMovie));
          return updatedMovie;
        });
    }

    this._store.setItem(movie.id, _model_films_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer(Object.assign({}, movie)));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _view_footer_statistics_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./view/footer-statistics.js */ "./src/view/footer-statistics.js");
...
/* harmony import */ var _presenter_filter_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./presenter/filter.js */ "./src/presenter/filter.js");
/* harmony import */ var _presenter_films_list_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./presenter/films-list.js */ "./src/presenter/films-list.js");
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _utils_const_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils/const.js */ "./src/utils/const.js");
/* harmony import */ var _model_films_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./model/films.js */ "./src/model/films.js");
/* harmony import */ var _model_filter_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./model/filter.js */ "./src/model/filter.js");
/* harmony import */ var _api_api_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./api/api.js */ "./src/api/api.js");
/* harmony import */ var _api_store_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./api/store.js */ "./src/api/store.js");
/* harmony import */ var _api_provider_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./api/provider.js */ "./src/api/provider.js");
...
const api = new _api_api_js__WEBPACK_IMPORTED_MODULE_8__["default"](_utils_const_js__WEBPACK_IMPORTED_MODULE_5__["END_POINT"], _utils_const_js__WEBPACK_IMPORTED_MODULE_5__["AUTHORIZATION"]);
const filmsStore = new _api_store_js__WEBPACK_IMPORTED_MODULE_9__["default"](STORE_NAME, window.localStorage);
const commentsStore = new _api_store_js__WEBPACK_IMPORTED_MODULE_9__["default"](STORE_NAME_COMMENTS, window.localStorage);
const apiWithProvider = new _api_provider_js__WEBPACK_IMPORTED_MODULE_10__["default"](api, filmsStore, commentsStore);

const filmsModel = new _model_films_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
...
let oldMenuItem = _utils_const_js__WEBPACK_IMPORTED_MODULE_5__["MenuItem"].CHANGE_FILTER;
let newMenuItem = _utils_const_js__WEBPACK_IMPORTED_MODULE_5__["MenuItem"].CHANGE_FILTER;
...
const handleStatsButtonClick = (menuItem) => {
  ...
  switch (menuItem) {
    case _utils_const_js__WEBPACK_IMPORTED_MODULE_5__["MenuItem"].CHANGE_FILTER:
      movieListPresenter.destroy();

      movieListPresenter = new _presenter_films_list_js__WEBPACK_IMPORTED_MODULE_3__["default"](
          apiWithProvider,
          siteHeaderElement,
          siteMainElement,
          filmsModel,
      ...
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["remove"])(userStatisticsComponent);
      break;
    case _utils_const_js__WEBPACK_IMPORTED_MODULE_5__["MenuItem"].STATS:
      movieListPresenter.destroy();
      filterPresenter.init();
      userStatisticsComponent = new _view_statistics_js__WEBPACK_IMPORTED_MODULE_1__["default"](filmsModel);
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(siteMainElement, userStatisticsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_4__["RenderPosition"].BEFOREEND);
...
filterPresenter = new _presenter_filter_js__WEBPACK_IMPORTED_MODULE_2__["default"](
    siteMainElement,
    filterModel,
    filmsModel,
...
apiWithProvider.getMovies()
  ...
  .then(() => {
    ...
    const moviesLocalForStore = moviesLocal.slice().map(_model_films_js__WEBPACK_IMPORTED_MODULE_6__["default"].adaptToServer);
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(siteFooterStatisticsElement, new _view_footer_statistics_js__WEBPACK_IMPORTED_MODULE_0__["default"](moviesLocal), _utils_render_js__WEBPACK_IMPORTED_MODULE_4__["RenderPosition"].BEFOREEND);
  })
  .then(() => {
    filterPresenter.init();
    movieListPresenter.init();
...
class Film {
  ...
  init(film) {
    this._film = film;
    this._currentUpdateType = this._activeFilter === _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL ? _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["UpdateType"].PATCH : _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["UpdateType"].MINOR;

    const prevFilmCardComponent = this._filmCardComponent;

    this._filmCardComponent = new _view_card_js__WEBPACK_IMPORTED_MODULE_0__["default"](this._film);
  ...
  _handleWatchlistClick() {
    this._changeData(
        _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["UserAction"].UPDATE_FILM,
    ...
    this._changeData(
        ...
        Object.assign(
            ...
            this._film,
            {
              ...
              watchingDate: !this._film.history ? moment__WEBPACK_IMPORTED_MODULE_3___default()().format() : null
            }
        )
    );
  }
...
/* harmony import */ var _view_sort_menu_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/sort-menu.js */ "./src/view/sort-menu.js");
/* harmony import */ var _view_films_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/films.js */ "./src/view/films.js");
/* harmony import */ var _view_no_data_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../view/no-data.js */ "./src/view/no-data.js");
/* harmony import */ var _view_button_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../view/button.js */ "./src/view/button.js");
/* harmony import */ var _view_loading_films_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../view/loading-films.js */ "./src/view/loading-films.js");
/* harmony import */ var _presenter_film_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../presenter/film.js */ "./src/presenter/film.js");
/* harmony import */ var _presenter_popup_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../presenter/popup.js */ "./src/presenter/popup.js");
/* harmony import */ var _utils_films_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utils/films.js */ "./src/utils/films.js");
...
class MovieList {
  constructor(
    ...
    this._renderedFilmCount = _utils_const_js__WEBPACK_IMPORTED_MODULE_11__["FILM_CARD_COUNT"];
    ...
    this._sectionFilmsComponent = new _view_films_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._profileRatingComponent = new _view_profile_rating_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
    this._loadingFilmsComponent = new _view_loading_films_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
  ...
  init() {
    this._activeFilterFilms = _utils_const_js__WEBPACK_IMPORTED_MODULE_11__["FilterType"].ALL;
    this._currentSortType = _utils_const_js__WEBPACK_IMPORTED_MODULE_11__["SortType"].DEFAULT;
  ...
  removeLoadingFilms() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._loadingFilmsComponent);
  }
  ...
  destroy() {
    ...
    if (this._sortMenuComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._sortMenuComponent);
    }
  ...
  _getFilms() {
    ...
    switch (this._currentSortType) {
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_11__["SortType"].DATE:
        return filteredFilms.sort(_utils_films_js__WEBPACK_IMPORTED_MODULE_8__["sortByDate"]);
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_11__["SortType"].RATING:
        return filteredFilms.sort(_utils_films_js__WEBPACK_IMPORTED_MODULE_8__["sortByRating"]);
    }
  ...
  _handleViewAction(actionType, updateType, update) {
    switch (actionType) {
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_11__["UserAction"].UPDATE_FILM:
  ...
  _handleModelEvent(updateType, data) {
    switch (updateType) {
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_11__["UpdateType"].PATCH:
        this._handleFilmUpdate(data);
        break;
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_11__["UpdateType"].MINOR:
        this._handleFilmUpdate(data);
        this._clearFilmsList();
        this._renderMain();
        break;
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_11__["UpdateType"].MAJOR:
        this._clearFilmsList(true, true);
        this._renderMain();
        break;
    }
  ...
  _renderPopupFilm(currentFilm) {
    ...
    this._filmPopupComponent = new _presenter_popup_js__WEBPACK_IMPORTED_MODULE_7__["default"](
        this._api,
  ...
  _handleLoadMoreButtonClick() {
    ...
    const mainFilmContainer = this._sectionFilmsComponent
      .getElement()
      .querySelector(`[data-type-container="${_utils_const_js__WEBPACK_IMPORTED_MODULE_11__["Containers"].MAIN}"]`);

    const filmCount = this._getFilms().length;
    const newRenderedFilmCount = Math.min(filmCount, this._renderedFilmCount + _utils_const_js__WEBPACK_IMPORTED_MODULE_11__["FILM_CARD_COUNT"]);

    this._renderCards(mainFilmContainer, this._renderedFilmCount, newRenderedFilmCount, _utils_const_js__WEBPACK_IMPORTED_MODULE_11__["Containers"].MAIN);
    this._renderedFilmCount = newRenderedFilmCount;

    if (this._renderedFilmCount >= filmCount) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._loadMoreButtonComponent);
    }
  }
  ...
  _renderLoadingFilms() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._container, this._loadingFilmsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
  }

  _renderNoData() {
    this._noDataComponent = new _view_no_data_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._container, this._noDataComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
  }

  _removeNoData() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._noDataComponent);
  ...
  _renderLoadMoreButton() {
    ...
    this._loadMoreButtonComponent = new _view_button_js__WEBPACK_IMPORTED_MODULE_4__["default"]();

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(siteFilmListElement, this._loadMoreButtonComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
  ...
  _renderProfileRating() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._head, this._profileRatingComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
  }
  ...
  _renderSort() {
    ...
    this._sortMenuComponent = new _view_sort_menu_js__WEBPACK_IMPORTED_MODULE_1__["default"](this._currentSortType);
    this._sortMenuComponent.setSortTypeChangeHandler(this._sortTypeChangeHandler);

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._container, this._sortMenuComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
  }

  _renderSectionFilms() {
    this._sectionFilmsComponent = new _view_films_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._container, this._sectionFilmsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
  }
  ...
  _prepareListFilms(type) {
    ...
    switch (type) {
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_11__["SortType"].RATING:
        return Object(_utils_films_js__WEBPACK_IMPORTED_MODULE_8__["sortElements"])(listFilms, type).filter((film) => film[_utils_const_js__WEBPACK_IMPORTED_MODULE_11__["SortType"].RATING] !== 0);
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_11__["SortType"].COMMENTS:
        return Object(_utils_films_js__WEBPACK_IMPORTED_MODULE_8__["sortElements"])(listFilms, type).filter((film) => film[_utils_const_js__WEBPACK_IMPORTED_MODULE_11__["SortType"].COMMENTS].length !== 0);
      default:
        return listFilms;
    }
  }
  ...
  _renderCards(container, from, to, type) {
    ...
    listFilms
      .slice(from, to)
      .forEach((film) => {
        const filmPresenter = new _presenter_film_js__WEBPACK_IMPORTED_MODULE_6__["default"](
            this._handleViewAction,
            this._activeFilterFilms
        );
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(container, fragment, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
  }
  ...
  _createMainCardFilms() {
    ...
    this._renderCards(mainFilmContainer, 0, Math.min(filmCount, this._renderedFilmCount), _utils_const_js__WEBPACK_IMPORTED_MODULE_11__["SortType"].DEFAULT);
  ...
  _createTopCardFilms() {
    const countTopFilms = this._getFilms()
      .slice()
      .filter((film) => film[_utils_const_js__WEBPACK_IMPORTED_MODULE_11__["SortType"].RATING] !== 0).length;

    if (countTopFilms) {
      const topFilmContainer = this._sectionFilmsComponent
        .getElement()
        .querySelector(`[data-type-container="${_utils_const_js__WEBPACK_IMPORTED_MODULE_11__["Containers"].TOP}"]`);

      this._renderCards(topFilmContainer, 0, _utils_const_js__WEBPACK_IMPORTED_MODULE_11__["FILM_EXTRA_CARD_COUNT"], _utils_const_js__WEBPACK_IMPORTED_MODULE_11__["SortType"].RATING);
    } else {
  ...
  _createCommentedCardFilms() {
    const countCommentedFilms = this._getFilms()
      .slice()
      .filter((film) => film[_utils_const_js__WEBPACK_IMPORTED_MODULE_11__["SortType"].COMMENTS].length !== 0).length;

    if (countCommentedFilms) {
      const commentedFilmContainer = this._sectionFilmsComponent
        .getElement()
        .querySelector(`[data-type-container="${_utils_const_js__WEBPACK_IMPORTED_MODULE_11__["Containers"].COMMENTED}"]`);

      this._renderCards(commentedFilmContainer, 0, _utils_const_js__WEBPACK_IMPORTED_MODULE_11__["FILM_EXTRA_CARD_COUNT"], _utils_const_js__WEBPACK_IMPORTED_MODULE_11__["SortType"].COMMENTS);
    } else {
      this._sectionFilmsComponent
        .getElement()
...
/* harmony import */ var _view_popup_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/popup.js */ "./src/view/popup.js");
/* harmony import */ var _view_comment_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/comment.js */ "./src/view/comment.js");
/* harmony import */ var _view_add_comment_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/add-comment.js */ "./src/view/add-comment.js");
/* harmony import */ var _model_comments_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../model/comments.js */ "./src/model/comments.js");
/* harmony import */ var _utils_const_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/const.js */ "./src/utils/const.js");
...
class Popup {
  ...
  init(film) {
    ...
    this._currentUpdateType = this._activeFilter === _utils_const_js__WEBPACK_IMPORTED_MODULE_4__["FilterType"].ALL ? _utils_const_js__WEBPACK_IMPORTED_MODULE_4__["UpdateType"].PATCH : _utils_const_js__WEBPACK_IMPORTED_MODULE_4__["UpdateType"].MAJOR;

    this.removePopup();

    const prevPopupComponent = this._popupComponent;

    this._popupComponent = new _view_popup_js__WEBPACK_IMPORTED_MODULE_0__["default"](this._film);
    this._commentsModel = new _model_comments_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
    ...
    if (prevPopupComponent === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(this._footer, this._popupComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
      return;
    }

    if (this._footer.contains(prevPopupComponent.getElement())) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["replace"])(this._popupComponent, prevPopupComponent);
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(prevPopupComponent);
  }
  ...
  removePopup() {
    ...
    if (this._popup) {
      ...
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["remove"])(this._popupComponent);
      this._popupComponent = null;
  ...
  _renderComments() {
    ...
    this._commentsModel.getComments().map((element) => {
      this._commentsComponent = new _view_comment_js__WEBPACK_IMPORTED_MODULE_1__["default"](element);

      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(commentsContainer, this._commentsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
  ...
  _renderAddComment() {
    ...
    this._newCommentComponent = new _view_add_comment_js__WEBPACK_IMPORTED_MODULE_2__["default"](this._handleViewAction);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(this._commentsMainContainer, this._newCommentComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);

    if (Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_6__["isOnline"])()) {
  ...
  _handleWatchlistClick() {
    this._changeData(
        _utils_const_js__WEBPACK_IMPORTED_MODULE_4__["UserAction"].UPDATE_FILM,
        this._currentUpdateType,
        Object.assign(
            {},
            this._film,
  ...
  _handleWatchedClick() {
    this._changeData(
        ...
        Object.assign(
            ...
            {
              history: !this._film.history,
              watchingDate: !this._film.history ? moment__WEBPACK_IMPORTED_MODULE_7___default()().format() : null
            }
        )
    );
  }
  ...
  _handleViewAction(actionType, updateType, update) {
    switch (actionType) {
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_4__["UserAction"].DELETE_COMMENT:

        this._api.deleteComment(update).then(() => {
          if (Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_6__["isOnline"])()) {
            this._changeData(
                _utils_const_js__WEBPACK_IMPORTED_MODULE_4__["UserAction"].UPDATE_FILM,
                _utils_const_js__WEBPACK_IMPORTED_MODULE_4__["UpdateType"].MINOR,
                Object.assign(
                    {},
                    this._film,
                    {
        ...
        break;
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_4__["UserAction"].ADD_COMMENT:
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: getRandomInteger, getRandomArbitrary, humanizeReleaseDate, getRank, isOnline */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "humanizeReleaseDate", function() { return humanizeReleaseDate; });
...
const humanizeReleaseDate = (date) => {
  return `${moment__WEBPACK_IMPORTED_MODULE_1___default()(date).format(`h`)}h ${moment__WEBPACK_IMPORTED_MODULE_1___default()(date).format(`m`)}m`;
};

const getRank = (moviesTotal) => {
  switch (true) {
    case (moviesTotal <= _const_js__WEBPACK_IMPORTED_MODULE_0__["UserRating"].NOVICE.maximumFilms) && (moviesTotal > _const_js__WEBPACK_IMPORTED_MODULE_0__["UserRating"].NONE.maximumFilms):
      return _const_js__WEBPACK_IMPORTED_MODULE_0__["UserRating"].NOVICE.name;
    case (moviesTotal <= _const_js__WEBPACK_IMPORTED_MODULE_0__["UserRating"].FAN.maximumFilms) && (moviesTotal > _const_js__WEBPACK_IMPORTED_MODULE_0__["UserRating"].NOVICE.maximumFilms):
      return _const_js__WEBPACK_IMPORTED_MODULE_0__["UserRating"].FAN.name;
    case (moviesTotal > _const_js__WEBPACK_IMPORTED_MODULE_0__["UserRating"].FAN.maximumFilms):
      return _const_js__WEBPACK_IMPORTED_MODULE_0__["UserRating"].MOVIE_BUFF.name;
    default:
      return _const_js__WEBPACK_IMPORTED_MODULE_0__["UserRating"].NONE.name;
  }
};
...
/*!****************************!*\
  !*** ./src/utils/const.js ***!
  \****************************/
/*! exports provided: FILM_CARD_COUNT, FILM_EXTRA_CARD_COUNT, END_POINT, AUTHORIZATION, Method, SuccessHTTPStatusRange, MenuItem, FilterType, SortType, UserRating, Containers, UserAction, UpdateType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FILM_CARD_COUNT", function() { return FILM_CARD_COUNT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FILM_EXTRA_CARD_COUNT", function() { return FILM_EXTRA_CARD_COUNT; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SuccessHTTPStatusRange", function() { return SuccessHTTPStatusRange; });
...
const AUTHORIZATION = `Basic jS7av3dnVwze1sa5p`;
...
/*!****************************!*\
  !*** ./src/utils/films.js ***!
  \****************************/
/*! exports provided: sortElements, sortByDate, sortByRating */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sortElements", function() { return sortElements; });
...
const sortElements = (films, element) => {
...
const sortByDate = (a, b) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(b.date).format(`YYYYMMDD`) - moment__WEBPACK_IMPORTED_MODULE_0___default()(a.date).format(`YYYYMMDD`);
};
...
const filter = {
  ...
  [_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].WATCHLIST]: (films) => films.filter((film) => film.watchlist),
  [_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].HISTORY]: (films) => films.filter((film) => film.history),
  [_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].FAVORITES]: (films) => films.filter((film) => film.favorites)
};
...
class AddComment extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(action) {
    super();
    this._action = action;
    this._comment = {};
  ...
  _emojiClickHandler(evt) {
    ...
    const newCommentEmojiElement = Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["createElement"])(newCommentEmojiTemplate(emoji));

    if (prevElement) {
      prevElement.remove();
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(container, newCommentEmojiElement, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
    } else {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(container, newCommentEmojiElement, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
    }
  }
  ...
  _sendMessageKeydownHandler(evt) {
    if (evt.ctrlKey && evt.key === `Enter`) {
      ...
      const comment = {
        text: textLocal,
        emoji: emojiLocal,
        date: moment__WEBPACK_IMPORTED_MODULE_3___default()().toISOString()
      };
      ...
      this._action(_utils_const_js__WEBPACK_IMPORTED_MODULE_2__["UserAction"].ADD_COMMENT, _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].MAJOR, comment);
    }
  }
}
...
const createFilmCardTemplate = (film) => {
  ...
  const filmYear = moment__WEBPACK_IMPORTED_MODULE_2___default()(date).format(`Y`);
  const filmDuration = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["humanizeReleaseDate"])(duration);
...
const createCommentTemplate = (comment) => {
  ...
  const timeAddComment = moment__WEBPACK_IMPORTED_MODULE_3___default()(date).fromNow();
  ...
  return `<li class="film-details__comment">
              ...
              <div>
                <p class="film-details__comment-text">${he__WEBPACK_IMPORTED_MODULE_2___default.a.encode(comment.text)}</p>
...
class Comment extends _smart_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(comment) {
    super();
  ...
  _handleDeleteClick(evt) {
    ...
    this._callback.deleteClick(_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["UserAction"].DELETE_COMMENT, _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["UpdateType"].MINOR, this._comment);
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SectionFilms; });
/* harmony import */ var _abstract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract.js */ "./src/view/abstract.js");
/* harmony import */ var _utils_const_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/const.js */ "./src/utils/const.js");
  ...
  return (
    `<section class="films">
      <section class="films-list">
        ...
        <div class="films-list__container"  data-type-container="${_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["Containers"].MAIN}">
        </div>
      </section>
      ...
      <section class="films-list--extra">
        ...
        <div class="films-list__container"  data-type-container="${_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["Containers"].TOP}">
        </div>
      </section>
      ...
      <section class="films-list--extra">
        ...
        <div class="films-list__container"  data-type-container="${_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["Containers"].COMMENTED}">
        </div>
      </section>
    </section>`
  );
...
class SectionFilms extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
...
/*!****************************!*\
  !*** ./src/view/filter.js ***!
  \****************************/
/*! exports provided: createFilterMenuTemplate, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createFilterMenuTemplate", function() { return createFilterMenuTemplate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FilterMenu; });
/* harmony import */ var _abstract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract.js */ "./src/view/abstract.js");
/* harmony import */ var _utils_const_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/const.js */ "./src/utils/const.js");
...
class FilterMenu extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _filterTypeChangeHandler(evt) {
    ...
    if (this._callback.statsButtonClick) {
      this._callback.statsButtonClick(_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].CHANGE_FILTER);
    }
  }

  _statsClickHandler(evt) {
    evt.preventDefault();
    this._callback.statsButtonClick(_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].STATS);
  }
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return LoadingFilms; });
/* harmony import */ var _abstract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract.js */ "./src/view/abstract.js");
...
class LoadingFilms extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
const createPopupTemplate = (data) => {
  ...
  const filmDuration = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["humanizeReleaseDate"])(duration);
  const release = moment__WEBPACK_IMPORTED_MODULE_3___default()(date).format(`D MMMM Y`);
...
class Popup extends _smart_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(film) {
    super();
  ...
  getElement() {
    if (!this._element) {
      this._element = Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["createElement"])(this.getTemplate());
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ProfileRating; });
...
class ProfileRating extends _abstract_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor() {
    super();

    this._films = null;
    this._profileRating = _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["UserRating"].NONE.name;
  }
  ...
  update(film) {
    ...
    this._profileRating = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getRank"])(historyFilmsCount);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return UserStatistics; });
/* harmony import */ var _abstract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract.js */ "./src/view/abstract.js");
/* harmony import */ var _utils_common_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/common.js */ "./src/utils/common.js");
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
...
/* harmony import */ var moment_duration_format__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! moment-duration-format */ "./node_modules/moment-duration-format/lib/moment-duration-format.js");
...
moment_duration_format__WEBPACK_IMPORTED_MODULE_6___default()(moment__WEBPACK_IMPORTED_MODULE_5___default.a);

moment__WEBPACK_IMPORTED_MODULE_5___default.a.updateLocale(`en`, {
  durationLabelTypes: [
    {type: `standard`, string: `__..`},
    {type: `short`, string: `_.`}
  ]
...
const createCharts = (genresAndCounts) => {
  ...
  return new chart_js__WEBPACK_IMPORTED_MODULE_3___default.a(statisticCtx, {
...
const createUserStatisticsTemplate = (totalFilms, totalDuration, topGenre) => {
  ...
  const time = moment__WEBPACK_IMPORTED_MODULE_5___default.a.duration(totalDuration, `minutes`).format(`h [${hourLetter}] mm [${minutesLetter}]`);
...
const createUserStatisticsPageTemplate = (totalFilms, totalDuration, topGenre) => {
  const rank = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["getRank"])(totalFilms);
...
class UserStatistics extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _formChangeHandler() {
    const now = moment__WEBPACK_IMPORTED_MODULE_5___default()().startOf(`day`);
          ...
          if (element.checked) {
            switch (element.id) {
              case `statistic-today`:
                this._films = preparedMovies.filter((movie) => moment__WEBPACK_IMPORTED_MODULE_5___default()(movie.watchingDate).isSame(moment__WEBPACK_IMPORTED_MODULE_5___default()(), `day`));
                break;
              case `statistic-week`:
                this._films = preparedMovies.filter((movie) => moment__WEBPACK_IMPORTED_MODULE_5___default()(movie.watchingDate).isAfter(week, `week`));
                break;
              case `statistic-month`:
                this._films = preparedMovies.filter((movie) => moment__WEBPACK_IMPORTED_MODULE_5___default()(movie.watchingDate).isAfter(month, `month`));
                break;
              case `statistic-year`:
                this._films = preparedMovies.filter((movie) => moment__WEBPACK_IMPORTED_MODULE_5___default()(movie.watchingDate).isAfter(year, `year`));
                break;
    ...
    const newStats = Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["createElement"])(createUserStatisticsTemplate(this._filmsWatched, this._duration, this._topGenre));

    const oldChart = this.getElement().querySelector(`.statistic__chart-wrap`);
    const newChart = Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["createElement"])(createUserChartTemplate);

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["replace"])(newStats, oldStats);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["replace"])(newChart, oldChart);
    this.getChart();
  }
}
